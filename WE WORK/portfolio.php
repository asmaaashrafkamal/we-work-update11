        ...
        <section class="portfolio">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul id="portfolio-flters">
                            ...
                            if($show1 !=null){
                            foreach($show1 as $r){
                             echo "<li data-filter='.".$r['cat_id']."'>".$r['cat_name']."</li>";
                            }}
                            ?>
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="500">
                 ...
                 if($show2 !=null){
                    foreach($show2 as $r){
                    echo'<div class="col-lg-4 col-md-6 '.$r['sub_id'].'">
                        <div class="portfolio-item">
                            <img src="../dashboard/'.$r['subcat1_position'].'" class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h3><a href="../dashboard/'.$r['subcat1_position'].'" data-gall="portfolioGallery" class="venobox" title="Mobile Applications"> '.$r['subcat1_name'].'</a></h3>
                                <div>
                                    <a href="../dashboard/'.$r['subcat1_position'].'" data-gall="portfolioGallery" class="venobox" title="Mobile Applications"><i class="bx bx-plus"></i></a>
                                    <a href="projects.php?id='.$r['sub_id'].'&sub1='.$r['cat_name'].'&sub2='.$r['subcat1_name'].'" title="Portfolio Details"><i class="bx bx-link"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>';
